...
<div class="col-md-12 col-sm-12" style="margin-left:370px; width:1080px;">
	<h2 style="padding-left:10px; padding:30px 0;"><a href="/adm/product/productlist.do">상품 관리</a></h2>
		<div class="table-responsive">
		 ...
		 <div class="paging" style="text-align: center; padding: 20px 0; margin-button:30px;">
		 	<div style="float:right;">
				<button type="button" class="rarara" style="width: 70px; height: 35px; line-height: 10px;" onclick="go_write()">상품등록</button>
			</div>
