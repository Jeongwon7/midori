	  ...
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			<div class="tbl_noticewrite">
			     <table class="noticewrite_table">
			      ...
			      <tbody>
			       <tr>
			        ...
			        <td colspan="3">
			         <input type="text" name="writer" id="writer" style="margin:0;" value="${nvo.writer}">
			        </td>
			       </tr>
			       <tr>
			        <th scope="row">
			        ...
			        <td colspan="3">
			         <input type="text" name="title" id="title" style="margin:0;width:500px;" value="${nvo.title}">
			        </td>
			       </tr>
			       <tr>
			        <th scope="row">
	    		...
	    		<div class="button_wrap">
	    		  ...
	    		  <p class="cart">
	    		  <input type="submit" class="btn_ok" value="수정하기">
	    		  </p>
	    		</div>
	    	  </div>
		</form>
