				 ...
				 <div class="midori_productpage">
				  <div class="midori_one">
				   ...
				   <div class="member_join" style="width:1050px;">
					<form class="form-horizontal" name="qafrm" method="post" style="border: 1px solid #ddd;"> 
					...
					<table class="tbl_comm">
			 	      <tbody>
			 	       <tr class="fst">
			 	        <th>제목 </th>
			 	        <td>
			 	         <input type="text"  name="qtitle" class="member_cont" id="qtitle" value="문의합니다:D">
			 	        </td>
			 	       </tr>
			 	       <tr>
			 	        <th>문의분류</th>
			 	       ...
			 	       <tr>
			 	        <th>내용</th>
			 	        <td>
			 	         <textarea name="qcontent" id="summernote" class="form-control" rows="10"></textarea>
			 	        </td>
			 	       </tr>
			 	       <tr>
			 	        <th>비밀글 설정</th>
			 	     ...
			 	     <div class="join_footer" style="padding-left:200px;">
					   <button class="btn_join btn_active" onclick="return question_save()">문의 등록</button>
